  ...
  return (
    <div className="flex w-full h-screen">
     ...
     <Image src="/Assets/logo.png" width={120} height={120} alt="logo" className="text-white absolute top-10 left-10"/>
       <div className="absolute items-center h-screen px-16  flex flex-col justify-center gap-1">
        <p className="text-white font-bold text-3xl lg:text-[44px]  text-center">Welcome to School Admin Portal!</p>
               <p className="text-white opacity-75 italic font-normal text-xl lg:text-2xl text-center">Please sign in  to access your campus  account</p>
                 <div className="absolute bottom-80 -right-10   py-60"><p className="text-black underline text-xl">Login</p></div>
       </div>
     </div>
      
        <div className="ms-24 mt-56">
          <div className="flex flex-col gap-6 mb-10">
             <Link href="/schoolAdmin"><p className="text-xl flex items-center gap-2">
