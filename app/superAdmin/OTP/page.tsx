  ...
  return (
    <div className="flex w-full h-screen">
     ...
     <Image src="/Assets/logo.png" width={120} height={120} alt="logo" className="text-white absolute top-10 left-10"/>
       <div className="absolute items-center h-screen px-16  flex flex-col justify-center gap-2">
        <p className="text-white font-bold text-[44px]  text-center">Welcome Back To Blink Campus!</p>
        ...
        <div className="ms-24 mt-56 ">
          ...
          <p className="text-black font-semibold text-5xl">Verify OTP</p>
            ...
            <p className="text-first text-xl mb-6">An authentication code has been sent to your email.</p>
