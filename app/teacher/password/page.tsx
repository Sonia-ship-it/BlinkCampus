  ...
  <div className="absolute items-center h-screen px-20  flex flex-col justify-center gap-3">
   <p className="text-white font-bold text-5xl  text-center">Welcome to Teacher's Portal!</p>
          <p className="text-white opacity-75 italic font-normal text-2xl text-center">Please sign in  to access your campus  account</p>
            <div className="absolute bottom-80 -right-12   py-60"><p className="text-black underline text-xl">Login</p></div>
  </div>
</div>
  <div className="ms-24 mt-56 ">
          ...
          <div className="bg-black w-16 h-1.5 rounded-lg"></div>
            ...
            <div className="flex flex-col ">
                <div className="relative w-xl mt-24">
                <input 
                    type="tel" 
                    id="phoneNumber" 
         ...
         <div className="flex items-center justify-between mt-6">
           ...
           <Link href="/teacher/forgot-password"><p className="text-blue-500 text-lg flex items-end">Forgot password?</p></Link>
    </div>
        <div className="flex items-center justify-center my-8">
            <Button className="font-semibold text-xl py-7 px-64">Sign In</Button></div>
            <p className="text-xl text-black text-center">Sign In with <Link href="/teacher" className="text-blue-500">OTP</Link></p>
    </div>
