       ...
       <div className="absolute items-center h-screen px-20  flex flex-col justify-center gap-3">
        ...
        <div className="ms-24 mt-56 ">
          <div className="flex flex-col gap-6 mb-10">
             <Link href="/parent"><p className="text-xl flex items-center gap-2">
          ...
          <p className="text-black font-semibold text-5xl">Verify OTP</p>
            ...
            <div className="flex flex-col">
                ...
                <label htmlFor="otp" className="absolute left-4 -top-2  text-md bg-white px-1" style={{color: '#1C1B1F'}}>
                    Enter OTP
                </label>
                           {showPassword ? ( 
