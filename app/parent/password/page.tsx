     ...
     <Image src="/Assets/logo.png" width={120} height={120} alt="logo" className="text-white absolute top-10 left-10"/>
       ...
       <div className="ms-24 mt-56 ">
         ...
         <div className="flex items-center justify-between mt-6">
           ...
           <Link href="/parent/forgot-password"><p className="text-blue-500 text-lg flex items-end">Forgot password?</p></Link>
    </div>
        <div className="flex items-center justify-center my-8">
            <Button className="font-semibold text-xl py-7 px-64">Sign In</Button></div>
            <p className="text-xl text-black text-center">Sign In with <Link href="/parent" className="text-blue-500">OTP</Link></p>
    </div>
    </div>
  );
}
