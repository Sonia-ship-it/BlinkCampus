  ...
  return (
    <div className="flex w-full h-screen">
     ...
     <Image src="/Assets/logo.png" width={120} height={120} alt="logo" className="text-white absolute top-10 left-10"/>
       <div className="absolute items-center h-screen px-24  flex flex-col justify-center gap-1">
        <p className="text-white font-bold text-[44px]  text-center">Welcome to Student's Portal!</p>
        ...
        <div className="ms-24 mt-56 ">
          <div className="flex flex-col gap-6 mb-10">
             <Link href="/student"><p className="text-xl flex items-center gap-2 cursor-pointer">
