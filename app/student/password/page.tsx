  ...
  <div className="ms-24 mt-48 ">
          ...
          <div className="bg-black w-16 h-1.5 rounded-lg"></div>
            ...
            <div className="flex flex-col ">
                <div className="relative w-xl mt-20">
                <input 
                    type="text" 
                    id="schoolName" 
         ...
         <div className="flex items-center justify-between mt-6">
           ...
           <Link href="/student/forgot-password"><p className="text-blue-500 text-lg flex items-end cursor-pointer">Forgot password?</p></Link>
    </div>
        <div className="flex items-center justify-center my-10">
            <Button className="font-semibold text-xl py-7 px-64">Sign In</Button></div>
            <p className="text-xl text-black text-center">Sign In with <Link href="/student" className="text-blue-500">PIN</Link></p>
    </div>
